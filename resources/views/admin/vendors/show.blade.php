            ...
            <div class="custom-sec mb-4">
                <div class="custom-sec__header">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.vendors.change-status', $vendor->id) }}" class="themeBtn {{ $vendor->status === 'active' ? 'themeBtn--danger' : 'themeBtn--success' }}">
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless mb-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge rounded-pill bg-{{ $vendor->status === 'active' ? 'success' : 'danger' }}">
                            ...
                            <tbody>
                                @foreach ($hotelBookings as $booking)
                                    <tr>
                                        ...
                                        <td>
                                            <span title="{{ $booking->hotel_name }}" style="max-width:180px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; display:inline-block;">
                                                {{ $booking->hotel_name }}
                                            </span>
                                        </td>
                                        <td>
