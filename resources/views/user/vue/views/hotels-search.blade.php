...
@push('css')
    <style>
        ...
        /*
         * Sticky toolbar: stretch destination + dates + pax to one row height (tallest column wins).
         * Parent uses align-items:stretch (.hs-mount--hotel-listing .fs-pro-card).
         */
        .hs-mount--hotel-listing .hotel-search-redesign .fs-pro-card {
            align-items: stretch !important;
        }

        .hs-mount--hotel-listing .hotel-search-redesign .fs-pro-route-pair--hotel-destination-only {
        ...
        .hs-mount--hotel-listing .hotel-search-redesign .fs-pro-date-pair--hotel-range {
            display: flex !important;
            align-self: stretch !important;
        }

        .hs-mount--hotel-listing .hotel-search-redesign .fs-pro-date-pair--hotel-range > .fs-pro-date-cell {
            flex: 1 1 auto !important;
            display: flex !important;
            flex-direction: column !important;
            min-height: 0 !important;
        ...
        .hs-mount--hotel-listing .hotel-search-redesign .fs-pro-pax-cabin-row--hotel-only > .fs-pro-travellers {
            flex: 1 1 auto !important;
            display: flex !important;
            flex-direction: column !important;
            justify-content: center !important;
