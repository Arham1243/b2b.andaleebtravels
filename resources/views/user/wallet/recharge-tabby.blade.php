    ...
    <div class="container">
        ...
        <div class="ps-shell">
            ...
            <div class="recharge-section">
                <h3 class="heading fw-bold mb-3">Tabby</h3>
                ...
                <form action="{{ route('user.wallet.recharge.tabby.process') }}" method="POST" id="rechargeForm">
                    ...
                    <div class="mb-4">
                        <div class="recharge-section__title">
                            <i class='bx bx-calendar-check'></i> Amount
                        </div>
                    ...
                    <div class="recharge-method-note">
                        <div class="recharge-method-note__icon"><i class='bx bxs-calendar-check'></i></div>
                        <div>
                            <div class="recharge-method-note__title">Split in 4 interest-free payments</div>
                            <p class="recharge-method-note__desc">Continue to Tabby to complete your wallet recharge with their installment options where available.</p>
                        </div>
                    </div>
