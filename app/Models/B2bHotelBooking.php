...
class B2bHotelBooking extends Model
{
    ...
    {
        do {
            $bookingNumber = 'B2BHB' . date('Ymd') . rand(1000, 9999);
    ...
    /**
     * Get the B2B vendor that owns the booking
     */
    ...
    /**
     * Scope to get bookings by vendor
     */
    public function scopeByVendor($query, $vendor)
    {
        return $query->where('b2b_vendor_id', $vendor->id);
    }
