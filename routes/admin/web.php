...
Route::middleware(['admin', 'admin.staff_gate'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('vendors/{vendor}/payment-reminder', [VendorController::class, 'sendPaymentReminder'])->name('vendors.payment-reminder');
    ...
    Route::get('flight-bookings/{flight_booking}/travelport-cert-logs', [AdminFlightBookingController::class, 'travelportCertLogs'])
        ->name('flight-bookings.travelport-cert-logs');
